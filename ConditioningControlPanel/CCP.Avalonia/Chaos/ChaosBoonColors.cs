...
public static class ChaosBoonColors
{
    ...
    /// <summary>An accent brush for <paramref name="id"/>, or <paramref name="fallback"/> if unmapped.</summary>
    ...
    /// <summary>The family color as an SKColor, or <paramref name="fallback"/>.</summary>
