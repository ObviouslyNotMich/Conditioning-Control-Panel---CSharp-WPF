...
namespace ConditioningControlPanel.Models
{
    ...
    public class Session
    {
        ...
        /// <summary>Short localized duration badge text (e.g. "30 min").</summary>
        public string DurationText => Loc.GetF("label_0_min", DurationMinutes);

        /// <summary>Short localized reward badge text (e.g. "+400 XP").</summary>
        public string RewardText => Loc.GetF("label_0_xp_3", BonusXP);

        /// <summary>Localized difficulty badge text.</summary>
        public string DifficultyText => GetDifficultyText();
