...
namespace ConditioningControlPanel.Core.Services.Help
{
    /// <summary>
    /// Cross-platform source of truth for in-app help / tutorial content.
    /// WPF and Avalonia heads consume this via their own thin facades so the
